...
app = FastAPI(
    ...
    description="A PostgreSQL-backed To-Do List CRUD API running in Docker for FlyRank AI Internship Backend Track",
    version="3.0",
    lifespan=lifespan
)
...
def read_all_tasks(
    ...
    search: Optional[str] = Query(None, description="Search tasks by title using Postgres ILIKE"),
